...
if a > b && a > c && a**2 == b**2 + c**2
  puts "Сторона а является гипотенузой. Треугольник является прямоугольным."
elsif b > a && b > c && b**2 == a**2 + c**2
  puts "Сторона b является гипотенузой. Треугольник является прямоугольным."
elsif c > a && c > b && c**2 == a**2 + b**2
  puts "Сторона c является гипотенузой. Треугольник является прямоугольным."
else
